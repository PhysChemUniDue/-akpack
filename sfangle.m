function sfAngle =...
    sfangle(wlVis,wlIR,n1SF,n1Vis,n1IR,angVis,angIR)
% Calculates the reflection angle of a SF beam.
%
% SFANGLE(wlVis,wlIR,n1SF,n1Vis,n1IR,angVis,angIR)
%
% Wavelength have to be given in meters, angles in radians relative to the surface normal.
%
% Reference: J. Loebau, K.
